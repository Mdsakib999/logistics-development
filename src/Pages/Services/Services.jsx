...
<div className="flex flex-col md:flex-row gap-3 items-center justify-between group">
          {servicesCards.map((service, index) => (
            <motion.div {...moveUp} key={index} className="max-w-md relative ">
              ...
              <button className="text-xl flex items-center gap-x-3 mt-4 border-b pb-1 text-gray-500 hover:text-red-400 cursor-pointer">Learn More <MdArrowOutward className="text-2xl" /></button>
            </motion.div>
          ))}
        </div>
